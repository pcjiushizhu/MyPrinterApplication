...
public class Printer {
    ...
    private final static String DEVICE_ID_HP_P1505          = "MFG:Hewlett-Packard;MDL:HP LaserJet P1505;CMD:HBS,PJL,ACL;CLS:PRINTER;DES:HP LaserJet P1505;FWVER:20100824;";
    ...
    public enum PrinterModel {
        ...
        HP_P1505("", "HP_P1505", DEVICE_ID_HP_P1505, "HelloWorld.epsonr330");
    ...
    private static void updatePrinterModel(UsbDeviceConnection connection) {
        ...
        if (deviceIdArray != null) {
            PrinterModel pm = matchPrinterModel(deviceIdStr);
            ret = pm;
            Log.e(LOG_TAG, "updatePrinterModel 打印机型号: " + pm.getDes());

            Toast.makeText(mContext,
                    "打印机型号: " + pm.getDes(), Toast.LENGTH_SHORT)
                    .show();
