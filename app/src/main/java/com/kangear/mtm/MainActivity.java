...
//        rxPermissions.request(Manifest.permission_group.STORAGE);
    ...
    public static final String TOP_DIR_NAME = "MEDATymp";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button:
                ...
                String pdf = getSDCardPath() + File.separator +
                        TOP_DIR_NAME  + File.separator + "HelloWorld.pdf";

                //pdf = "//storage//sdcard0//Download//PrintBitmap.pdf";
